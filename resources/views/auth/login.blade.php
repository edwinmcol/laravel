    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('login') }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <label class="flex items-center">
                ...
                <input class="border rounded dark:bg-slate-900 dark:border-slate-700 text-sky-700 focus:border-sky-300 focus:ring-slate-300 dark:focus:ring-slate-800 focus:ring-opacity-50" 
                    name="remember" 
                    type="checkbox" >
